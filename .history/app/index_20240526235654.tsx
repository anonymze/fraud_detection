	...
	return (
		<Container>
			...
			<View style={{ flexDirection: "row", flexWrap: "wrap", justifyContent: "center", gap: 25, width: "100%", marginTop: 20 }}>
				<Card onPress={() => router.push('hair-care')} title={i18nDefault("SEARCH_PRODUCT")} imageUrl={require("@/assets/images/logo-1.png")} background="#faeaeb" />
				<Card onPress={() => router.push('/hair-care')} title={i18nDefault("SEARCH_PRODUCT")} imageUrl={require("@/assets/images/logo-1.png")} background="#f3faf2" />
				<Card onPress={() => router.push('/hair-care')} title={i18nDefault("SEARCH_PRODUCT")} imageUrl={require("@/assets/images/logo-1.png")} background="#fdf8fd" />
				<Card onPress={() => router.push('/hair-care')} title={i18nDefault("SEARCH_PRODUCT")} imageUrl={require("@/assets/images/logo-1.png")} background="#fef0e2" />
			</View>
		</Container>
	);
}
