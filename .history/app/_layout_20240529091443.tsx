	...
	return (
		...
		>
			...
			<Stack.Screen name="detection" options={{
				header: (props) =>
					(
						<View style={{ height: 100, alignItems: "center", justifyContent: "center" }} {...props}>
							<Text style={{ fontSize: 24, fontWeight: "bold", textAlign: "center", color: "black" }}>Take a picture of your product</Text>
						</View>
					),
			}} />
		</Stack>
