	...
	return (
		<Container>
			...
			<View style={{ flexDirection: "row", flexWrap: "wrap", gap: 25, maxWidth: boxWidthScreen, marginTop: 20 }}>
				...
				<Card title="coucou" imageUrl="@/assets/images/logo-1.png" background="#f3faf2" />
				<Card title="coucou" imageUrl="@/assets/images/logo-1.png" background="#fdf8fd" />
				<Card title="coucou" imageUrl="@/assets/images/logo-1.png" background="#fef0e2" />
			</View>
		</Container>
	);
}
