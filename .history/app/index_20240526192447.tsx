...
export default function Index() {
	...
	return (
		<Container>
			...
			<TextInput style={{ width: 200, marginTop: 25, padding: 16, borderColor: "gray", borderWidth: 1, borderRadius: 99 }} placeholderTextColor="gray" placeholder={i18nDefault("SEARCH_PRODUCT")} />
		</Container>
	);
}