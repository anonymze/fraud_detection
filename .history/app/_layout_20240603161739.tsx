	...
	return (
		<Stack
			screenOptions={{
				...
				// },
				headerTitle: (props) => {
					return (<View style={{ flex: 1, width: "100%", height: 100, backgroundColor: "green" }} {...props}>
							<View style={{width: "100%", height: 80, backgroundColor: "red"}}></View>
							<View style={{width: "100%", height: 20, backgroundColor: "blue"}}><Text>oki</Text></View>
						</View>
					)
				},
