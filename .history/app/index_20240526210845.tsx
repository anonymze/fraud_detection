...
export default function Index() {
	...
	return (
		<Container>
			...
			<View style={{ flexDirection: "row", flexWrap: "wrap", justifyContent: "center", gap: 25, flex: 1, marginTop: 20 }}>
				<Card title="coucou" imageUrl={require("@/assets/images/logo-1.png")} background="#faeaeb" />
				<Card title="coucou" imageUrl={require("@/assets/images/logo-1.png")} background="#f3faf2" />
				<Card title="coucou" imageUrl={require("@/assets/images/logo-1.png")} background="#fdf8fd" />
				<Card title="coucou" imageUrl={require("@/assets/images/logo-1.png")} background="#fef0e2" />
			</View>
		</Container>
	);
}
