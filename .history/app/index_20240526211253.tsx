	...
	return (
		<Container>
			...
			<View style={{ flexDirection: "row", flexWrap: "wrap", justifyContent: "center", gap: 25, width: "100%", marginTop: 20 }}>
				<Card title="Makeup" imageUrl={require("@/assets/images/logo-1.png")} background="#faeaeb" />
				<Card title="Skin care" imageUrl={require("@/assets/images/logo-1.png")} background="#f3faf2" />
				<Card title="Hair care" imageUrl={require("@/assets/images/logo-1.png")} background="#fdf8fd" />
				<Card title="Hair color" imageUrl={require("@/assets/images/logo-1.png")} background="#fef0e2" />
			</View>
		</Container>
	);
}
