				...
				header: (props) =>
					(
						<View style={{ height: 100, alignItems: "center", justifyContent: "center", backgroundColor: "#fff" }} {...props}>
							<Text style={{ fontSize: 26, fontWeight: "bold", textAlign: "center", color: "#000" }}>Take a picture</Text>
							<Text style={{ fontSize: 26, fontWeight: "bold", textAlign: "center", color: "#000" }}>of your product</Text>
						</View>
					),
			}} />
		</Stack>
