...
const deviceLanguages = getLocales()[0]?.languageCode;

if (!deviceLanguage) {
	const lol  = "en" as const;
	console.log(deviceLanguage);
}
deviceLanguage = !deviceLanguage ? "en" as const : (deviceLanguage === "fr" || deviceLanguage === "en") ? deviceLanguage : "en" as const;
